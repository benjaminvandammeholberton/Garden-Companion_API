...
@vegetable_info_router.get('/', summary='Get all vegetable_infos of the user',
...
@vegetable_info_router.post('/create', summary="Create VegetableInfo", response_model=VegetableInfoOut)
async def create_vegetable_info(data: VegetableInfoCreate,
...
@vegetable_info_router.get('/{vegetable_info_id}', summary='Get a vegetable_info by vegetable_info_id',
                 response_model=VegetableInfoOut)
async def retrieve(vegetable_info_id: UUID,
                   current_user: User = Depends(get_current_user)):
    """
    ...
    """
    return await VegetableInfoService.retrieve_vegetable(current_user, vegetable_info_id)


@vegetable_info_router.put('/{vegetable_info_id}', summary="Update vegetable_info by vegetable_info_id",
                 response_model=VegetableInfoOut)
async def update(vegetable_info_id: UUID, data: VegetableInfoUpdate,
                 current_user: User = Depends(get_current_user)):
    """
    ...
    """
    return await VegetableInfoService.update_vegetable(current_user, vegetable_info_id, data)


@vegetable_info_router.delete('/{vegetable_info_id}', summary="Delete vegetable_info by vegetable_info_id")
async def delete(vegetable_info_id: UUID,
                 current_user: User = Depends(get_current_user)):
    """
    ...
    :return: None.
    """
    await VegetableInfoService.delete_vegetable(current_user, vegetable_info_id)
    return None
